/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Live Leaflet GIS tracking with Auto-Retry & Resilience Engine
   ═══════════════════════════════════════════════════════════════════════════ */
...
(function () {
  ...
  // Initialize Leaflet GIS Map with Auto-Retry Logic
  function initLeafletMap() {
    const mapEl = document.getElementById('command-map');
    if (!mapEl) return;
    
    // Auto retry if Leaflet JS library is still loading
    ...
    try {
      // Ensure height style is set
      mapEl.style.minHeight = '440px';
  ...
  // DOM Loaded Listener & Auto Retry Init
  ...
  // Backup window load trigger for Leaflet
